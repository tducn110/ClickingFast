...
export const PRODUCE_ITEMS: ProduceDefinition[] = [
  {
    ...
    emoji: "🥭",
    behavior: "normal",
    texturePath: "/assets/fruits/mango.webp",
    visualSize: 102,
    anchor: { x: 0.5, y: 0.5 },
    hitboxScale: 0.9,
    shadowScale: 0.85,
  },
  {
    ...
    emoji: "🍎",
    behavior: "heavy",
    texturePath: "/assets/fruits/apple.webp",
    visualSize: 96,
    anchor: { x: 0.5, y: 0.5 },
    hitboxScale: 0.88,
    shadowScale: 0.9,
  },
  {
    ...
    emoji: "🍐",
    behavior: "sway",
    texturePath: "/assets/fruits/pear.webp",
    visualSize: 92,
    anchor: { x: 0.5, y: 0.5 },
    hitboxScale: 0.92,
    shadowScale: 0.82,
  },
  {
    ...
    emoji: "🍓",
    behavior: "normal",
    texturePath: "/assets/fruits/strawberry.webp",
    visualSize: 90,
    anchor: { x: 0.5, y: 0.5 },
    hitboxScale: 0.9,
    shadowScale: 0.82,
  },
  {
    ...
    emoji: "🍈",
    behavior: "heavy",
    texturePath: "/assets/fruits/guava.webp",
    visualSize: 98,
    anchor: { x: 0.5, y: 0.5 },
    hitboxScale: 0.9,
    shadowScale: 0.88,
...
export const HAZARD_ITEMS: HazardDefinition[] = [
  {
    ...
    emoji: "🐝",
    behavior: "buzz",
    texturePath: "/assets/items/bee.webp",
    visualSize: 76,
    anchor: { x: 0.5, y: 0.5 },
    hitboxScale: 0.9,
    shadowScale: 0.8,
  },
  {
    ...
    emoji: "🐛",
    behavior: "sway",
    texturePath: "/assets/items/worm.webp",
    visualSize: 70,
    anchor: { x: 0.5, y: 0.5 },
    hitboxScale: 0.9,
    shadowScale: 0.78,
  },
  {
    ...
    emoji: "🤢",
    behavior: "heavy",
    texturePath: "/assets/items/rotten.webp",
    visualSize: 80,
    anchor: { x: 0.5, y: 0.5 },
    hitboxScale: 0.88,
    shadowScale: 0.85,
...
export const POWERUP_ITEMS: PowerupDefinition[] = [
  {
    ...
    emoji: "❤️",
    behavior: "normal",
    texturePath: "/assets/items/heart.webp",
    visualSize: 72,
    anchor: { x: 0.5, y: 0.5 },
    hitboxScale: 0.9,
    shadowScale: 0.8,
  },
  {
    ...
    emoji: "⚡",
    behavior: "sway",
    texturePath: "/assets/items/lightning.webp",
    visualSize: 78,
    anchor: { x: 0.5, y: 0.5 },
    hitboxScale: 0.9,
    shadowScale: 0.8,
  },
  {
    ...
    emoji: "⏳",
    behavior: "sway",
    texturePath: "/assets/items/slow-time.webp",
    visualSize: 76,
    anchor: { x: 0.5, y: 0.5 },
    hitboxScale: 0.92,
    shadowScale: 0.8,
